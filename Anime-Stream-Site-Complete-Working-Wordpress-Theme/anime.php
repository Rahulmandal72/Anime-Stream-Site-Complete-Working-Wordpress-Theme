...
if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['page'])) {
    $_SESSION['anime_page'] = intval($_POST['page']);
    wp_safe_remote_post(get_permalink(), array('blocking' => false));
}

// Get current page
$current_page = isset($_SESSION['anime_page']) ? intval($_SESSION['anime_page']) : 1;
...
<div class="anime-container">
    ...
    $anime = new WP_Query($args);

    if($anime->have_posts()):
        while($anime->have_posts()): 
            $anime->the_post();
    ...
    <?php 
        ...
        echo '<div class="no-results"><span>🔍</span><p>No anime found</p></div>';
    endif;
    ...
    <!-- PAGINATION -->
    <?php 
    $total_pages = $anime->max_num_pages;
    if($total_pages > 1): 
    ?>
    ...
    <div class="pagination-info">
        ...
        (Total: <strong><?php echo $anime->found_posts; ?></strong> anime)
    </div>
    <?php endif; ?>
