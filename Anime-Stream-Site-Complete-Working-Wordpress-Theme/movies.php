...
if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['page'])) {
    $_SESSION['movies_page'] = intval($_POST['page']);
    wp_safe_remote_post(get_permalink(), array('blocking' => false));
}

// Get current page
$current_page = isset($_SESSION['movies_page']) ? intval($_SESSION['movies_page']) : 1;
...
<div class="movies-container">
    ...
    // GENRE FILTER — ARRAY FIELD (backend)
    if (!empty($_GET['genre'])) {
        $meta_query[] = [
            'key'     => 'genre',
    ...
    <?php 
        ...
        echo '<div class="no-results"><span>🔍</span><p>No movies found</p></div>';
    endif;
    ...
    <div class="pagination-info">
        ...
        (Total: <strong><?php echo $movies->found_posts; ?></strong> movies)
    </div>
    <?php endif; ?>
